/*!	@file
	@brief PluggableVR: 手順遷移 待ち合わせ画面 
	@author NullPopPoLab
...
{
	//! 手順遷移 待ち合わせ画面 
	internal class Flow_LobbyScene : Flow_Common
	{
		...
		protected override Flow OnUpdate()
		{
			...
			return new Flow_Delay(new Flow_LobbyScene_Main());
		}
	}

	//! 手順遷移 待ち合わせ画面 本体 
	internal class Flow_LobbyScene_Main : Flow_Common
	{
		protected override void OnStart()
		{
			Global.Logger.LogInfo(ToString() + " bgn");

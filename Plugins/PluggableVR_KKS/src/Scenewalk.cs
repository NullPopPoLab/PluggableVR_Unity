...
namespace PluggableVR_KKS
{
	...
	internal class Scenewalk: SceneReportBase
	{
		...
		internal Scenewalk(){
			...
			_scene["Assets/Illusion/Game/Scene/EstheticProc.unity"] = new Scene_EstheticProc();
			_scene["Assets/Illusion/Game/Scene/EstheticScene.unity"] = new Scene_EstheticScene();

...
@echo PluggableVR_BepInEx\src\PluggableVR\ and ..\Assets\Scripts\PluggableVR\
@echo ...
...
xcopy /d/s/y PluggableVR_BepInEx\src\PluggableVR\*.cs ..\Assets\Scripts\PluggableVR\
xcopy /d/s/y ..\Assets\Scripts\PluggableVR\*.cs PluggableVR_BepInEx\src\PluggableVR\
@pause
